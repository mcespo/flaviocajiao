    ...
    <div class="mx-auto max-w-7xl md:px-6 lg:px-8">
      ...
      >
        ...
        <div class="sm:px-6 lg:px-0">
          ...
          >
          <img
            class="aspect-[3/2] w-full bg-gray-50 object-cover relative isolate overflow-hidden sm:mx-auto sm:max-w-2xl sm:rounded-3xl lg:mx-0 lg:max-w-none"
            src="./../assets/dr-flavio-cajiao.jpg"
            alt=""
          />
          </div>
        </div>
...
<script setup>
import { CloudUploadIcon, CloudIcon, ServerIcon } from "@vue-hero-icons/solid";
